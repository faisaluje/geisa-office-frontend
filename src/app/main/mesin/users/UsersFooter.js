...
import { setParamsListUsers } from '../store/usersSlice';

function UsersFooter() {
	const dispatch = useDispatch();
	const { table, params } = useSelector(({ mesin }) => mesin.users);
	...
	return (
		<div className="flex flex-wrap mt-10 p-8 justify-center w-full bg-gray-50">
			<div className="flex flex-1 items-center font-bold">Total Users : {table?.meta?.totalItems}</div>
