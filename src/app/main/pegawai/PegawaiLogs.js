    ...
    <DialogContent classes={{ root: 'p-16' }}>
      <div className="flex flex-row justify-between w-full">
        <DatePicker
          ...
          onChange={date =>
            dispatch(setParamsListPegawaiLogs({ ...params, tglAwal: date ? date.format('YYYY-MM-DD') : '' }))
          }
          disableFuture
          format="YYYY-MM-DD"
        />
        ...
        <DatePicker
          ...
          onChange={date =>
            dispatch(setParamsListPegawaiLogs({ ...params, tglAkhir: date ? date.format('YYYY-MM-DD') : '' }))
          }
          disableFuture
          format="YYYY-MM-DD"
        />
      ...
      {isError ? (
        ...
        <MaterialTable
          isLoading={isLoading}
          columns={[
            { title: 'Tanggal', field: 'date', defaultGroupOrder: 0, defaultGroupSort: 'desc' },
