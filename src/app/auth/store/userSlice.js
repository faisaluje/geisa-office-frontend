...
export const setUserData = (accessToken, settings) => async (dispatch, getState) => {
	/*
	...
	*/
	...
	const role = user.peran === 3 ? authRoles.staff : authRoles.admin;
...
export const updateUserSettings = settings => async (dispatch, getState) => {
	...
	return dispatch(setUserData(accessToken, settings));
};
...
export const { setUser, userLoggedOut, setIsOnline } = userSlice.actions;
