...
import { setUserDataFirebase, setUserDataAuth0, setUserData, logoutUser, setIsOnline } from './store/userSlice';
		...
		new Promise(resolve => {
			jwtService.on('onAutoLogin', () => {
				...
				jwtService
					.signInWithToken()
					.then(accessToken => {
						this.props.setUserData(accessToken);

						resolve();
						this.props.showMessage({ message: 'Selamat datang kembali!' });
					})
					.catch(error => {
